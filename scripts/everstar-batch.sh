...
echo ""
echo "[DONE] All tickets started!"
echo ""
echo "[STATS] Monitor progress:"
for TICKET in "${TICKETS[@]}"; do
    echo "   tail -f /tmp/everstar-$TICKET.log"
done
echo ""
echo "[WAIT] Waiting for all tickets to complete..."
echo ""
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "[DONE] Batch complete: ${#TICKETS[@]} tickets processed"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
for TICKET in "${TICKETS[@]}"; do
    ...
    if [ -d "$WORKTREE" ]; then
        ...
        if git diff-index --quiet HEAD --; then
            echo "  [ERROR] $TICKET - No changes"
        else
            echo "  [DONE] $TICKET - Changes made"
        fi
    else
        echo "  [WARN]  $TICKET - Worktree not found"
    fi
done

echo ""
echo "[INFO] Check logs at: /tmp/everstar-*.log"
echo ""
